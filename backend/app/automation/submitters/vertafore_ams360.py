"""Vertafore AMS360 agency-management submitter (Playwright)."""
...
class VertaforeAMS360Submitter(PlaywrightSubmitter):
    """Vertafore AMS360 submitter.

    URL :env:`PORTAL_VERTAFORE_AMS360_URL`, creds
    :env:`VERTAFORE_AMS360_USERNAME` / :env:`VERTAFORE_AMS360_PASSWORD`.
    """

    platform = PortalPlatform.VERTAFORE_AMS360
    PLATFORM = PortalPlatform.VERTAFORE_AMS360
    URL_ENV_VAR = "PORTAL_VERTAFORE_AMS360_URL"
    USERNAME_ENV_VAR = "VERTAFORE_AMS360_USERNAME"
    PASSWORD_ENV_VAR = "VERTAFORE_AMS360_PASSWORD"  # noqa: S105
    PORTAL_REFERENCE_PREFIX = "V360"
    SMOKE_PROBE_NEEDLE = "AMS360"
    ...
    def _login(self, page: Page, *, url: str, username: str, password: str) -> None:
        ...
        try:
            ...
            raise PortalAuthError(
                ...
                user_message="Vertafore AMS360 login form did not render.",
                cause=str(exc),
            ) from exc
    ...
    def _fill_form(self, page: Page, payload: dict[str, Any]) -> None:
        ...
        fills: list[tuple[str, str]] = [
            ...
            ("ams360_agency_code", str(payload.get("ams360_agency_code", ""))),
...
SUBMITTER_REGISTRY[PortalPlatform.VERTAFORE_AMS360] = VertaforeAMS360Submitter
