...
const STATUS_STYLES: Record<SubmissionStatus, PillStyle> = {
  ...
  queued: {
    label: 'Queued',
    className: 'bg-amber-100 text-amber-800 ring-amber-200 dark:bg-amber-900/40 dark:text-amber-200 dark:ring-amber-800',
  },
  retrying: {
    label: 'Retrying',
    className: 'bg-amber-100 text-amber-800 ring-amber-200 dark:bg-amber-900/40 dark:text-amber-200 dark:ring-amber-800',
  ...
  blocked: {
    label: 'Blocked',
    className: 'bg-purple-100 text-purple-800 ring-purple-200 dark:bg-purple-900/40 dark:text-purple-200 dark:ring-purple-800',
  },
