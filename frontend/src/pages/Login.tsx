    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 dark:bg-slate-950">
      <div className="w-full max-w-md rounded-lg border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="mb-6 flex items-center gap-2">
          ...
          <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100">Sign in to Once</h1>
        </div>
        <p className="mb-6 text-sm text-slate-500 dark:text-slate-400">Submit once. Prove it forever.</p>
        ...
        <p className="mt-6 text-sm text-slate-600 dark:text-slate-400">
          New to Once?{" "}
          <Link to="/register" className="font-medium text-slate-900 underline hover:no-underline dark:text-slate-200">
            Create an account
          </Link>
        </p>
